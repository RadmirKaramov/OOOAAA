...
urlpatterns += [
    ...
    path('chapters/<int:pk>/update/', views.ChapterUpdate.as_view(), name='chapter_update'),
    path('chapters/<int:pk>/delete/', views.ChapterDelete.as_view(), name='chapter_delete'),
]
