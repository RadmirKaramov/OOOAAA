...
class Report(models.Model):
    ...
    chapter_text_1 = models.CharField(max_length=20000, null=True, help_text='')
    ...
    chapter_text_2 = models.CharField(max_length=20000, null=True, help_text='')
    ...
    chapter_text_3 = models.CharField(max_length=20000, null=True, help_text='')
    ...
    chapter_text_4 = models.CharField(max_length=20000, null=True, help_text='')
    ...
    chapter_text_5 = models.CharField(max_length=20000, null=True, help_text='')
    ...
    chapter_text_6 = models.CharField(max_length=20000, null=True, help_text='')
